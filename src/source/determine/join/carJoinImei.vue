                ...
                <div class="search-table">
                    ...
                    <div class="extra-table" :class="tableActiveClass">
                        ...
                        <el-table 
                            ...
                            <el-table-column prop="addr" label="采集地点" ></el-table-column>
                            <el-table-column prop="targetTime" :label="'采集时间\n(车牌:'+ajaxConf.data.carplate+')'" :formatter="hqDateFormat1"></el-table-column>
    ...
    export default {
        ...
        data() {
            return {
                ...
                ajaxConf: {
                    url: "",
                    url1: "/relate/carplate-imsi",
                    url2: "/relate/carplate-imsi-detail",
                    url3: "/relate/carplate-imsi-area",
                    url4: "/relate/carplate-imsi-addr",
                    url5: "/relate/carplate-imsi-time",
                    data: {
                        list: [],
                        currentPage: 1,
                        pageSize: 50,
        ...
        methods: {
            ...
            queryInit: async function(){
                ...
                this.ajaxConf.data.carplate = this.imei;
                this.ajaxConf.data1.carplate = this.imei;
            ...
            timeThrow() {
                ...
                this.$parent.addNewTab({
                    url: "map/analyze/car/join/imsi",
                    text: "车牌关联IMSI/IMEI轨迹地图",
                    name: "AnalyzeToolCarJoinIMSIMap",
                    query: {
                        key: this.ajaxConf.data.sessionKey,
                        imsis: imsis.join(','),
                        car: this.ajaxConf.data.carplate,
