    ...
    export default {
        ...
        data() {
            return {
                ...
                ajaxConf: {
                    url: "",
                    url1: "/relate/mac-carplate",
                    url2: "/relate/mac-carplate-detail",
                    url3: "/relate/mac-carplate-area",
                    url4: "/relate/mac-carplate-addr",
                    url5: "/relate/mac-carplate-time",
                    data: {
                        list: [],
                        currentPage: 1,
                        pageSize: 50,
