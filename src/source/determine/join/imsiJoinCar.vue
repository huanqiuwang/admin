                ...
                <div class="search-table">
                    ...
                    <div class="extra-table" :class="tableActiveClass">
                        ...
                        <el-table 
                            ...
                            <el-table-column prop="addr" label="采集地点" ></el-table-column>
                            <el-table-column prop="targetTime" :label="ajaxConf.data.imsi?'采集时间\n(IMSI:'+ajaxConf.data.imsi+')':'采集时间\n(IMEI:'+ajaxConf.data.imei+')'" :formatter="hqDateFormat1"></el-table-column>
                            <el-table-column prop="realTime" :label="'采集时间\n(车牌:'+ajaxConf.data1.carplate+')'" :formatter="hqDateFormat1"></el-table-column>
                        </el-table>
    ...
    export default {
        ...
        data() {
            return {
                ...
                ajaxConf: {
                    url: "",
                    url1: "/relate/imsi-carplate",
                    url2: "/relate/imsi-carplate-detail",
                    url3: "/relate/imsi-carplate-area",
                    url4: "/relate/imsi-carplate-addr",
                    url5: "/relate/imsi-carplate-time",
                    data: {
                        list: [],
                        currentPage: 1,
                        pageSize: 50,
        ...
        methods: {
            ...
            showTable: async function(row, column, cell, event){
                ...
                this.ajaxConf.data1.carplate = row.target;
