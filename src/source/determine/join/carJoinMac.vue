    ...
    export default {
        ...
        data() {
            return {
                ...
                ajaxConf: {
                    url: "",
                    url1: "/relate/carplate-mac",
                    url2: "/relate/carplate-mac-detail",
                    url3: "/relate/carplate-mac-area",
                    url4: "/relate/carplate-mac-addr",
                    url5: "/relate/carplate-mac-time",
                    data: {
                        list: [],
                        currentPage: 1,
                        pageSize: 50,
