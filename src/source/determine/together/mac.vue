                ...
                <div class="search-table">
                    ...
                    <div class="extra-table" :class="tableActiveClass">
                        ...
                        <el-table 
                            ...
                            <el-table-column prop="target" :label="'采集时间\n(MAC:'+mac+')'" :formatter="hqDateFormat1"></el-table-column>
        ...
        methods: {
            ...
            showTable: async function(row, column, cell, event){
                ...
                if(column.label == "时间匹配度"){
                    type = 3;
                    e = await loading(AJAX.post(this.ajaxConf.url5+'/'+row.mac+'/'+this.time,{key: _this.searchKey}));
